...
\ProvidesPackage{themevut}[2018/05/22 Brno University of Technology theme]
...
\defbeamertemplate*{frametitle}{ru theme}{%
    ...
    \begin{beamercolorbox}[wd=\paperwidth,ht=1cm,leftskip=.5cm,rightskip=.1cm]{frametitle}
        \usebeamerfont*{frametitle}\raisebox{0ex}{\insertframetitle}\hfill\raisebox{-0.9ex}{\includegraphics[height=.825cm]{logo.png}}
        \vskip.4ex
    \end{beamercolorbox}%
    \nointerlineskip
}
